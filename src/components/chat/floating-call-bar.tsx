  ...
  if (callState === "error") {
    return (
      <div className="relative">
        <div className="rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-destructive/30 overflow-hidden" style={{background: "hsl(217, 20%, 22%)"}}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="max-w-[150px] truncate text-xs" style={{color: "hsl(210, 10%, 60%)"}}>
  ...
  if (callState === "requesting-permission" || callState === "connecting") {
    return (
      <div className="relative">
        ...
        <div className="relative rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] overflow-hidden" style={{background: "hsl(217, 20%, 22%)", border: "1px solid hsl(217, 15%, 25%)"}}>
          ...
          <div className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold" style={{color: "hsl(210, 10%, 93%)"}}>{coworker.name}</p>
                <p className="text-xs" style={{color: "hsl(210, 10%, 60%)"}}>
          ...
          <div className="p-4">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold" style={{color: "hsl(210, 10%, 93%)"}}>On Call</div>
            ...
            <div className="flex items-center justify-between gap-2">
              <Button
                ...
                style={{borderColor: "hsl(217, 15%, 25%)"}}
              ...
              <div className="flex-1 flex justify-center items-center h-10 gap-0.5">
                {isSpeaking ? (
                  ...
                  <div className="h-1 w-full rounded-full" style={{background: "hsl(217, 20%, 20%)"}} />
                )}
              </div>
