    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">1. Platform Usage and Account</h2>
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">2. Assessment and Interview Conduct</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Platform-Exclusive Communications</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">4. Non-Circumvention Agreement</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">5. Data Usage and Privacy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">6. Your Rights to Your Data</h2>
          <p className="text-gray-700 mb-4">Candidates retain the following rights regarding their personal data:</p>
          <ul className="list-disc list-inside text-gray-700 mb-6 ml-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">8. Free Services and Paid Features</h2>
          <p className="text-gray-700 mb-6">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">9. Prohibited Conduct</h2>
          <p className="text-gray-700 mb-4">Candidates agree not to:</p>
          <ul className="list-disc list-inside text-gray-700 mb-6 ml-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">12. Modification of Terms</h2>
          <p className="text-gray-700 mb-6">
