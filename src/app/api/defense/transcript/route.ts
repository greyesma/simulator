 ...
 *
 * POST: Save defense call transcript
 * GET: Retrieve defense call transcript
 *
 * Uses the Conversation model with type "defense" and coworkerId = managerId
 */
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Find or create the defense conversation
    ...
    if (existingConversation) {
      ...
      // Create new defense conversation
    ...
    console.error("Error saving defense transcript:", error);
    return NextResponse.json(
...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("Error retrieving defense transcript:", error);
    return NextResponse.json(
