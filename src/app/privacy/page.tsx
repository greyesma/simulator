    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="border-l-4 border-secondary pl-6 mb-8">
          <p className="text-lg">
            At Skillvee, we take your privacy seriously. This Privacy Policy explains how we collect,
            use, disclose, and safeguard your information when you use our developer assessment platform.
          </p>
        </div>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          <li>
            <strong className="text-foreground">Screen recordings:</strong> Video capture of your screen during the
            coding task portion of the assessment
          </li>
          <li>
            <strong className="text-foreground">Voice recordings:</strong> Audio from HR interviews, manager kickoff
            calls, and PR defense sessions
          </li>
          <li>
            <strong className="text-foreground">Conversation transcripts:</strong> Text transcriptions of all voice
            and chat interactions
          </li>
          <li>
            <strong className="text-foreground">CV/Resume:</strong> Documents you upload for use during the assessment
          </li>
          <li>
            <strong className="text-foreground">Code submissions:</strong> Links to pull requests and code you submit
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>Analyze your problem-solving approach and communication skills</li>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>Analyze screen recordings to understand your development workflow</li>
          <li>Review code quality, patterns, and security practices</li>
          <li>Generate comprehensive assessment reports</li>
        </ul>
        <p className="text-muted-foreground mb-4">
          We use Google&apos;s Gemini AI models for processing. Your data is transmitted securely
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>Recordings and documents are stored securely on Supabase Storage</li>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>
            <strong className="text-foreground">Assessment recordings:</strong> Retained for 1 year after completion
          </li>
          <li>
            <strong className="text-foreground">Assessment reports:</strong> Retained indefinitely unless you request
            deletion
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>
            <strong className="text-foreground">Deletion:</strong> Request deletion of your data (see below)
          </li>
          <li>
            <strong className="text-foreground">Portability:</strong> Receive your data in a portable format
          </li>
          <li>
            <strong className="text-foreground">Withdraw consent:</strong> Opt out of future data collection
          </li>
        </ul>

        <div className="border-2 border-border p-6 my-8 bg-accent/10">
          <h3 className="font-bold mb-2">Requesting Data Deletion</h3>
          <p className="text-muted-foreground mb-4">
            You can request deletion of your data at any time from your profile settings.
            We will process your request within 30 days and confirm deletion via email.
          </p>
          <Link
            href="/profile"
            className="inline-block bg-foreground text-background px-4 py-2 font-semibold border-2 border-foreground hover:bg-secondary hover:text-secondary-foreground hover:border-secondary"
          >
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
          ...
          <li>
            <strong className="text-foreground">Google (Gemini AI):</strong> AI processing for assessments
          </li>
          <li>
        ...
        <p className="text-muted-foreground mb-4">
          Each of these services has their own privacy policies governing data handling.
        </p>
        ...
        <div className="border-2 border-border p-6 bg-accent/10">
          <p className="font-mono">
            Email: privacy@skillvee.com
          </p>
        </div>
      ...
      <footer className="border-t-2 border-border">
        <div className="max-w-4xl mx-auto px-6 py-8 text-center text-muted-foreground font-mono text-sm">
