  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="relative">
                  <div className="bg-white rounded-2xl p-8 h-full shadow-sm">
                    ...
                    <div className="text-4xl font-bold text-stone-900 mb-1">1</div>
                ...
                <div className="relative">
                  <div className="bg-white rounded-2xl p-8 h-full shadow-sm">
                    ...
                    <div className="text-4xl font-bold text-stone-900 mb-1">2</div>
                ...
                <div className="relative">
                  <div className="bg-white rounded-2xl p-8 h-full shadow-sm">
                    ...
                    <div className="text-4xl font-bold text-stone-900 mb-1">3</div>
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-6">
          ...
          <SectionReveal className="mt-8 max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 bg-white rounded-lg p-4 border border-stone-200">
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-6">
          ...
          <SectionReveal>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              <Card className="bg-white border-2 border-stone-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all">
              ...
              <Card className="bg-white border-2 border-stone-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg font-bold text-stone-900 mb-2">AI tool usage</h3>
                  <p className="text-stone-600 text-sm">
              ...
              <Card className="bg-white border-2 border-stone-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg font-bold text-stone-900 mb-2">Communication</h3>
                  <p className="text-stone-600 text-sm">
              ...
              <Card className="bg-white border-2 border-stone-200 shadow-sm hover:border-blue-300 hover:shadow-md transition-all">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-lg font-bold text-stone-900 mb-2">Work style</h3>
                  <p className="text-stone-600 text-sm">
      ...
      <section className="relative py-20 sm:py-24 bg-stone-50">
        ...
        <CurveDivider fillColor="fill-stone-900" />
      </section>
